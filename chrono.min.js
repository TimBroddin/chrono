...
function baseOption(e){return{parsers:[new parser.ENISOFormatParser(e),new parser.ENDeadlineFormatParser(e),new parser.ENMonthNameLittleEndianParser(e),new parser.ENMonthNameMiddleEndianParser(e),new parser.ENSlashDateFormatParser(e),new parser.ENSlashDateFormatStartWithYearParser(e),new parser.ENTimeAgoFormatParser(e),new parser.ENTimeExpressionParser(e),new parser.NLISOFormatParser(e),new parser.NLDeadlineFormatParser(e),new parser.NLMonthNameLittleEndianParser(e),new parser.NLMonthNameMiddleEndianParser(e),new parser.NLSlashDateFormatParser(e),new parser.NLSlashDateFormatStartWithYearParser(e),new parser.NLTimeAgoFormatParser(e),new parser.NLTimeExpressionParser(e),new parser.JPStandardParser(e),new parser.ESTimeAgoFormatParser(e),new parser.ESDeadlineFormatParser(e),new parser.ESTimeExpressionParser(e),new parser.ESMonthNameLittleEndianParser(e),new parser.ESSlashDateFormatParser(e)],refiners:[new refiner.OverlapRemovalRefiner,new refiner.ENMergeDateTimeRefiner,new refiner.ENMergeDateRangeRefiner,new refiner.JPMergeDateRangeRefiner,new refiner.NLMergeDateRangeRefiner,new refiner.ExtractTimezoneOffsetRefiner,new refiner.ExtractTimezoneAbbrRefiner,new refiner.UnlikelyFormatFilter]}}var parser=require("./parsers/parser"),refiner=require("./refiners/refiner");exports.strictOption=function(){return baseOption(!0)},exports.casualOption=function(){var e=baseOption(!1);return e.parsers.unshift(new parser.ENCasualDateParser),e.parsers.unshift(new parser.ENWeekdayParser),e.parsers.unshift(new parser.NLCasualDateParser),e.parsers.unshift(new parser.NLWeekdayParser),e.parsers.unshift(new parser.JPCasualDateParser),e.parsers.unshift(new parser.ESCasualDateParser),e.parsers.unshift(new parser.ESWeekdayParser),e};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(nu|vandaag|vanavond|morgen|mrg|gisteren|gisteren\s*avond|deze\s*(ochtend|middag|namiddag|avond))(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,t,a){var e=t[0].substr(t[1].length),s=t.index+t[1].length,n=new ParsedResult({index:s,text:e,ref:r}),i=moment(r),d=i.clone(),o=e.toLowerCase();if("vanavond"==o)n.start.imply("hour",18),n.start.imply("meridiem",1);else if("morgen"==o||"mrg"==o)i.hour()>1&&d.add(1,"day");else if("gisteren"==o)d.add(-1,"day");else if(o.match(/gisteren\s*avond/))n.start.imply("hour",0),i.hour()>6&&d.add(-1,"day");else if(o.match("deze")){var m=t[3].toLowerCase();"namiddag"==m?n.start.imply("hour",15):"middag"==m?n.start.imply("hour",12):"avond"==m?n.start.imply("hour",18):"ochtend"==m&&n.start.imply("hour",6)}else o.match("nu")&&(n.start.imply("hour",i.hour()),n.start.imply("minute",i.minute()),n.start.imply("second",i.second()));return n.start.assign("day",d.date()),n.start.assign("month",d.month()+1),n.start.assign("year",d.year()),n.tags.NLCasualDateParser=!0,n}};
},{"../../result":43,"../parser":33,"moment":1}],24:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(binnen|in)\s*([0-9]+|een|twee|drie|vier|vijf|tien|vijftien|twintig|dertig|veertig|een?|(?:\s*een ?)?half|(?:\s*een ?)?halve)\s*(minuut?|minuten?|kwartier?|uur?|uren?|dag?|dagen?)\s*(?=(?:\W|$))/i,NUMBERS=require("../../utils/NL").NUMBERS;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,t,r,a){var n=r.index+r[1].length,e=r[0];e=r[0].substr(r[1].length,r[0].length-r[1].length);var i=new ParsedResult({index:n,text:e,ref:t}),s=r[3];s="een"===s?1:s.match(/half/)?.5:NUMBERS[s]?NUMBERS[s]:parseInt(s);var u=moment(t);return r[4].match(/dag/)||r[4].match(/dagen/)?(u.add(s,"d"),i.start.assign("year",u.year()),i.start.assign("month",u.month()+1),i.start.assign("day",u.date()),i):(r[4].match(/uur/)||r[4].match(/uren/)?u.add(s,"hour"):r[4].match(/minuut/)||r[4].match(/minuten/)?u.add(s,"minute"):r[4].match(/kwartier/)&&u.add(15*s,"minute"),i.start.imply("year",u.year()),i.start.imply("month",u.month()+1),i.start.imply("day",u.date()),i.start.assign("hour",u.hour()),i.start.assign("minute",u.minute()),i.tags.NLDeadlineFormatParser=!0,i)}};
},{"../../result":43,"../../utils/NL":47,"../parser":33,"moment":1}],25:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})\\-([0-9]{1,2})\\-([0-9]{1,2})(?:T([0-9]{1,2}):([0-9]{1,2})(?::([0-9]{1,2})(?:\\.(\\d{1,4}))?)?(?:Z|([+-]\\d{2}):?(\\d{2})?)?)?(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4,HOUR_NUMBER_GROUP=5,MINUTE_NUMBER_GROUP=6,SECOND_NUMBER_GROUP=7,MILLISECOND_NUMBER_GROUP=8,TZD_HOUR_OFFSET_GROUP=9,TZD_MINUTE_OFFSET_GROUP=10;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,e,s,r){var t=s[0].substr(s[1].length),n=s.index+s[1].length,R=new ParsedResult({text:t,index:n,ref:e});if(R.start.assign("year",parseInt(s[YEAR_NUMBER_GROUP])),R.start.assign("month",parseInt(s[MONTH_NUMBER_GROUP])),R.start.assign("day",parseInt(s[DATE_NUMBER_GROUP])),moment(R.start.get("month"))>12||moment(R.start.get("month"))<1||moment(R.start.get("day"))>31||moment(R.start.get("day"))<1)return null;if(null!=s[HOUR_NUMBER_GROUP])if(R.start.assign("hour",parseInt(s[HOUR_NUMBER_GROUP])),R.start.assign("minute",parseInt(s[MINUTE_NUMBER_GROUP])),null!=s[SECOND_NUMBER_GROUP]&&R.start.assign("second",parseInt(s[SECOND_NUMBER_GROUP])),null!=s[MILLISECOND_NUMBER_GROUP]&&R.start.assign("millisecond",parseInt(s[MILLISECOND_NUMBER_GROUP])),null==s[TZD_HOUR_OFFSET_GROUP])R.start.assign("timezoneOffset",0);else{var a=0,_=parseInt(s[TZD_HOUR_OFFSET_GROUP]);null!=s[TZD_MINUTE_OFFSET_GROUP]&&(a=parseInt(s[TZD_MINUTE_OFFSET_GROUP]));var U=60*_;0>U?U-=a:U+=a,R.start.assign("timezoneOffset",U)}return R.tags.NLISOFormatParser=!0,R}};
},{"../../result":43,"../parser":33,"moment":1}],26:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/NL"),DAYS_OFFSET={zondag:0,zon:0,maandag:1,ma:1,dinsdag:2,di:2,woensdag:3,woe:3,donderdag:4,"do":4,don:4,vrijdag:5,vr:5,zaterdag:6,za:6,zat:6},PATTERN=new RegExp("(\\W|^)(?:(zondag|maandag|dinsdag|woensdag|donderdag|vrijdag|zaterdag|zon|ma|di|woe|don|do|vr|za|zat)\\s*,?\\s*)?([0-9]{1,2})(?:ste|e|de)?(?:\\s*(?:tot|\\-|\\–|tot|\\s)\\s*([0-9]{1,2})(?:st|e|de)?)?\\s*(?:van)?\\s*(jan(?:uari|\\.)?|feb(?:ruari|\\.)?|ma(?:art|\\.)?|apr(?:il|\\.)?|Mei|jun(?:i|\\.)?|jul(?:i|\\.)?|aug(?:ustus|\\.)?|sep(?:tember|\\.)?|oct(?:ober|\\.)?|nov(?:ember|\\.)?|dec(?:ember|\\.)?)(?:(\\s*[0-9]{2,4}(?![^\\s]\\d))(\\s*BE)?)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,DATE_GROUP=3,DATE_TO_GROUP=4,MONTH_NAME_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(a,e,t,r){var s=new ParsedResult({text:t[0].substr(t[1].length,t[0].length-t[1].length),index:t.index+t[1].length,ref:e}),n=t[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var d=t[DATE_GROUP];d=parseInt(d);var i=null;if(t[YEAR_GROUP]&&(i=t[YEAR_GROUP],i=parseInt(i),t[YEAR_BE_GROUP]?i-=543:100>i&&(i+=2e3)),i)s.start.assign("day",d),s.start.assign("month",n),s.start.assign("year",i);else{var o=moment(e);o.month(n-1),o.date(d),o.year(moment(e).year());var E=o.clone().add(1,"y"),m=o.clone().add(-1,"y");Math.abs(E.diff(moment(e)))<Math.abs(o.diff(moment(e)))?o=E:Math.abs(m.diff(moment(e)))<Math.abs(o.diff(moment(e)))&&(o=m),s.start.assign("day",d),s.start.assign("month",n),s.start.imply("year",o.year())}if(t[WEEKDAY_GROUP]){var g=t[WEEKDAY_GROUP];g=util.WEEKDAY_OFFSET[g.toLowerCase()],s.start.assign("weekday",g)}return t[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(t[DATE_TO_GROUP]))),s.tags.NLMonthNameLittleEndianParser=!0,s}};
},{"../../result":43,"../../utils/NL":47,"../parser":33,"moment":1}],27:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/NL"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PATTERN=new RegExp("(\\W|^)(?:(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun\\.?|Mon\\.?|Tue\\.?|Wed\\.?|Thu\\.?|Fri\\.?|Sat\\.?)\\s*,?\\s*)?(Jan\\.?|January|Feb\\.?|February|Mar\\.?|March|Apr\\.?|April|May\\.?|Jun\\.?|June|Jul\\.?|July|Aug\\.?|August|Sep\\.?|Sept\\.?|September|Oct\\.?|October|Nov\\.?|November|Dec\\.?|December)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*(?:(?:to|\\-)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*)?(?:\\s*,?\\s*(s*[0-9]{4})(\\s*BE)?\\s*)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,MONTH_NAME_GROUP=3,DATE_GROUP=4,DATE_TO_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,a,t,r){var s=new ParsedResult({text:t[0].substr(t[1].length,t[0].length-t[1].length),index:t.index+t[1].length,ref:a}),n=t[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var d=t[DATE_GROUP];d=parseInt(d);var u=null;if(t[YEAR_GROUP]&&(u=t[YEAR_GROUP],u=parseInt(u),t[YEAR_BE_GROUP]?u-=543:100>u&&(u+=2e3)),u)s.start.assign("day",d),s.start.assign("month",n),s.start.assign("year",u);else{var i=moment(a);i.month(n-1),i.date(d);var E=i.clone().add(1,"y"),o=i.clone().add(-1,"y");Math.abs(E.diff(moment(a)))<Math.abs(i.diff(moment(a)))?i=E:Math.abs(o.diff(moment(a)))<Math.abs(i.diff(moment(a)))&&(i=o),s.start.assign("day",d),s.start.assign("month",n),s.start.imply("year",i.year())}if(t[WEEKDAY_GROUP]){var y=t[WEEKDAY_GROUP];y=util.WEEKDAY_OFFSET[y.toLowerCase()],s.start.assign("weekday",y)}return t[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(t[DATE_TO_GROUP]))),s.tags.ENMonthNameMiddleEndianParser=!0,s}};
},{"../../result":43,"../../utils/NL":47,"../parser":33,"moment":1}],28:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)(?:((?:zon?|maa?|di?|woe?|don?|vri?|zat?))\\s*\\,?\\s*)?([0-9]{1,2})[\\/\\.\\-]([0-9]{1,2})(?:[\\/\\.\\-]([0-9]{4}|[0-9]{2}))?(\\W|$)","i"),DAYS_OFFSET={zondag:0,zon:0,maandag:1,ma:1,dinsdag:2,di:2,woensdag:3,woe:3,donderdag:4,"do":4,don:4,vrijdag:5,vr:5,zaterdag:6,za:6,zat:6},OPENNING_GROUP=1,ENDING_GROUP=6,WEEKDAY_GROUP=2,MONTH_GROUP=4,DAY_GROUP=3,YEAR_GROUP=5;exports.Parser=function(e){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,a,t){if("/"==a[OPENNING_GROUP]||"/"==a[ENDING_GROUP])return void(a.index+=a[0].length);var n=a.index+a[OPENNING_GROUP].length,e=a[0].substr(a[OPENNING_GROUP].length,a[0].length-a[ENDING_GROUP].length),s=new ParsedResult({text:e,index:n,ref:r});if(!e.match(/^\d\.\d$/)&&!e.match(/^\d\.\d{1,2}\.\d{1,2}$/)&&(a[YEAR_GROUP]||!(a[0].indexOf("/")<0))){var P=a[YEAR_GROUP]||moment(r).year()+"",d=a[MONTH_GROUP],i=a[DAY_GROUP];if(d=parseInt(d),i=parseInt(i),P=parseInt(P),(1>d||d>12)&&d>12){if(!(i>=1&&12>=i&&d>=13&&31>=d))return null;var O=d;d=i,i=O}return 1>i||i>31?null:(100>P&&(P>50?P=P+2500-543:P+=2e3),s.start.assign("day",i),s.start.assign("month",d),s.start.assign("year",P),a[WEEKDAY_GROUP]&&s.start.assign("weekday",DAYS_OFFSET[a[WEEKDAY_GROUP].toLowerCase()]),s.tags.NLSlashDateFormatParser=!0,s)}}};
},{"../../result":43,"../parser":33,"moment":1}],29:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})[\\-\\.\\/]([0-9]{1,2})[\\-\\.\\/]([0-9]{1,2})(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,e,r,s){var t=r[0].substr(r[1].length),a=r.index+r[1].length,n=new ParsedResult({text:t,index:a,ref:e});return n.start.assign("year",parseInt(r[YEAR_NUMBER_GROUP])),n.start.assign("month",parseInt(r[MONTH_NUMBER_GROUP])),n.start.assign("day",parseInt(r[DATE_NUMBER_GROUP])),moment(n.start.get("month"))>12||moment(n.start.get("month"))<1||moment(n.start.get("day"))>31||moment(n.start.get("day"))<1?null:(n.tags.NLDateFormatParser=!0,n)}};
},{"../../result":43,"../parser":33,"moment":1}],30:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(?:binnen\s*)?([0-9]+|een?|half?|halve?)\s*(minuut?|minuten?|uur?|uren?|week?|weken?|dag?|dagen?|maand?|maanden?|jaar?|jaren?)\s*(?:geleden|terug)(?=(?:\W|$))/i,STRICT_PATTERN=/(\W|^)(?:binnen\s*)?([0-9]+|an?)\s*(minuut?|minuten?|uur?|uren?|week?|weken?|dag?|dagen?|maand?|maanden?|jaar?|jaren?)\s*geleden(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return this.isStrictMode()?STRICT_PATTERN:PATTERN},this.extract=function(a,e,t,n){if(t.index>0&&a[t.index-1].match(/\w/))return null;var a=t[0];a=t[0].substr(t[1].length,t[0].length-t[1].length),index=t.index+t[1].length;var r=new ParsedResult({index:index,text:a,ref:e}),m=t[2];m="een"===m?1:m.match(/half/)||m.match(/halve/)?.5:parseInt(m);var s=moment(e);return t[3].match(/uur/)||t[3].match(/uren/)||t[3].match(/minuut/)||t[3].match(/minuten/)?(t[3].match(/uur/)||t[3].match(/uren/)?s.add(-m,"hour"):(t[3].match(/minuut/)||t[3].match(/minuten/))&&s.add(-m,"minute"),r.start.imply("day",s.date()),r.start.imply("month",s.month()+1),r.start.imply("year",s.year()),r.start.assign("hour",s.hour()),r.start.assign("minute",s.minute()),r.tags.NLTimeAgoFormatParser=!0,r):t[3].match(/week/)||t[3].match(/weken/)?(s.add(-m,"week"),r.start.imply("day",s.date()),r.start.imply("month",s.month()+1),r.start.imply("year",s.year()),r.start.imply("weekday",s.day()),r):((t[3].match(/dag/)||t[3].match(/dagen/))&&s.add(-m,"d"),(t[3].match(/maand/)||t[3].match(/maanden/))&&s.add(-m,"month"),(t[3].match(/jaar/)||t[3].match(/jaren/))&&s.add(-m,"year"),r.start.assign("day",s.date()),r.start.assign("month",s.month()+1),r.start.assign("year",s.year()),r)}};
},{"../../result":43,"../parser":33,"moment":1}],31:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,ParsedComponents=require("../../result").ParsedComponents,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:om|vanaf)\\s*)?(\\d{1,4}|middag|middernacht)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\:|\\：)(\\d{2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\–|\\~|\\〜|tot|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(u?)(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,t,r,n){if(r.index>0&&e[r.index-1].match(/\w/))return null;var s=moment(t),a=new ParsedResult;a.ref=t,a.index=r.index+r[1].length,a.text=r[0].substring(r[1].length),a.tags.NLTimeExpressionParser=!0,a.start.imply("day",s.date()),a.start.imply("month",s.month()+1),a.start.imply("year",s.year());var i=0,d=0,u=-1;if(null!=r[SECOND_GROUP]){var l=parseInt(r[SECOND_GROUP]);if(l>=60)return null;a.start.assign("second",l)}if("middag"==r[HOUR_GROUP].toLowerCase()?(u=1,i=12):"middernacht"==r[HOUR_GROUP].toLowerCase()?(u=0,i=0):i=parseInt(r[HOUR_GROUP]),null!=r[MINUTE_GROUP]?d=parseInt(r[MINUTE_GROUP]):i>100&&(d=i%100,i=parseInt(i/100)),d>=60)return null;if(i>24)return null;if(i>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(i>12)return null;var P=r[AM_PM_HOUR_GROUP][0].toLowerCase();"a"==P&&(u=0,12==i&&(i=0)),"p"==P&&(u=1,12!=i&&(i+=12))}if(a.start.assign("hour",i),a.start.assign("minute",d),u>=0&&a.start.assign("meridiem",u),r=SECOND_REG_PATTERN.exec(e.substring(a.index+a.text.length)),!r)return a.text.match(/^\d+$/)?null:a;if(r[0].match(/^\s*(\+|\-)\s*\d{3,4}$/))return a;null==a.end&&(a.end=new ParsedComponents(null,a.start.date()));var i=0,d=0,u=-1;if(null!=r[SECOND_GROUP]){var l=parseInt(r[SECOND_GROUP]);if(l>=60)return null;a.end.assign("second",l)}if(i=parseInt(r[2]),null!=r[MINUTE_GROUP]){if(d=parseInt(r[MINUTE_GROUP]),d>=60)return a}else i>100&&(d=i%100,i=parseInt(i/100));if(d>=60)return null;if(i>24)return null;if(i>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(i>12)return null;"a"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=0,12==i&&(i=0,a.end.isCertain("day")||a.end.imply("day",a.end.get("day")+1))),"p"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=1,12!=i&&(i+=12)),a.start.isCertain("meridiem")||(0==u?(a.start.imply("meridiem",0),12==a.start.get("hour")&&a.start.assign("hour",0)):(a.start.imply("meridiem",1),12!=a.start.get("hour")&&a.start.assign("hour",a.start.get("hour")+12)))}else i>=12&&(u=1);return a.text=a.text+r[0],a.end.assign("hour",i),a.end.assign("minute",d),u>=0&&a.end.assign("meridiem",u),a.end.date().getTime()<a.start.date().getTime()&&a.end.imply("day",a.end.get("day")+1),a}};
},{"../../result":43,"../parser":33,"moment":1}],32:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,DAYS_OFFSET={zondag:0,zon:0,maandag:1,ma:1,dinsdag:2,di:2,woensdag:3,woe:3,donderdag:4,"do":4,don:4,vrijdag:5,vr:5,zaterdag:6,za:6,zat:6},PATTERN=new RegExp("(\\W|^)(?:(?:\\,|\\(|\\（)\\s*)?(?:(this|last|next)\\s*)?("+Object.keys(DAYS_OFFSET).join("|")+")(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(this|last|next)\\s*week)?(?=\\W|$)","i"),PREFIX_GROUP=2,WEEKDAY_GROUP=3,POSTFIX_GROUP=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,a,t,r){var s=t.index+t[1].length,e=t[0].substr(t[1].length,t[0].length-t[1].length),n=new ParsedResult({index:s,text:e,ref:a}),d=t[WEEKDAY_GROUP].toLowerCase(),o=DAYS_OFFSET[d];if(void 0===o)return null;var i=moment(a),l=t[PREFIX_GROUP],y=t[POSTFIX_GROUP];if(l||y){var P=l||y;P=P.toLowerCase(),"vorige"==P||"afgelopen"==P?i.day(o-7):"volgende"==P||"komende"==P?i.day(o+7):"deze"==P&&i.day(o)}else{var g=i.day();r.forwardDatesOnly&&g>o?i.day(o+7):!r.forwardDatesOnly&&Math.abs(o-7-g)<Math.abs(o-g)?i.day(o-7):!r.forwardDatesOnly&&Math.abs(o+7-g)<Math.abs(o-g)?i.day(o+7):i.day(o)}return n.start.assign("weekday",o),n.start.imply("day",i.date()),n.start.imply("month",i.month()+1),n.start.imply("year",i.year()),n}};
},{"../../result":43,"../parser":33,"moment":1}],33:[function(require,module,exports){
function Parser(r){this.isStrictMode=function(){return 1==r},this.pattern=function(){return/./i},this.extract=function(r,e,a,s){return null},this.execute=function(r,e,a){for(var s=[],t=this.pattern(),i=r,P=t.exec(i);P;){P.index+=r.length-i.length;var o=this.extract(r,e,P,a);o?(i=r.substring(o.index+o.text.length),this.isStrictMode()&&!o.hasPossibleDates()||s.push(o)):i=r.substring(P.index+1),P=t.exec(i)}return this.refiners&&this.refiners.forEach(function(){s=refiner.refine(s,r,options)}),s}}exports.Parser=Parser,exports.ENISOFormatParser=require("./EN/ENISOFormatParser").Parser,exports.ENDeadlineFormatParser=require("./EN/ENDeadlineFormatParser").Parser,exports.ENMonthNameLittleEndianParser=require("./EN/ENMonthNameLittleEndianParser").Parser,exports.ENMonthNameMiddleEndianParser=require("./EN/ENMonthNameMiddleEndianParser").Parser,exports.ENSlashDateFormatParser=require("./EN/ENSlashDateFormatParser").Parser,exports.ENSlashDateFormatStartWithYearParser=require("./EN/ENSlashDateFormatStartWithYearParser").Parser,exports.ENTimeAgoFormatParser=require("./EN/ENTimeAgoFormatParser").Parser,exports.ENTimeExpressionParser=require("./EN/ENTimeExpressionParser").Parser,exports.ENWeekdayParser=require("./EN/ENWeekdayParser").Parser,exports.ENCasualDateParser=require("./EN/ENCasualDateParser").Parser,exports.JPStandardParser=require("./JP/JPStandardParser").Parser,exports.JPCasualDateParser=require("./JP/JPCasualDateParser").Parser,exports.ESCasualDateParser=require("./ES/ESCasualDateParser").Parser,exports.ESDeadlineFormatParser=require("./ES/ESDeadlineFormatParser").Parser,exports.ESTimeAgoFormatParser=require("./ES/ESTimeAgoFormatParser").Parser,exports.ESTimeExpressionParser=require("./ES/ESTimeExpressionParser").Parser,exports.ESWeekdayParser=require("./ES/ESWeekdayParser").Parser,exports.ESMonthNameLittleEndianParser=require("./ES/ESMonthNameLittleEndianParser").Parser,exports.ESSlashDateFormatParser=require("./ES/ESSlashDateFormatParser").Parser,exports.NLISOFormatParser=require("./NL/NLISOFormatParser").Parser,exports.NLDeadlineFormatParser=require("./NL/NLDeadlineFormatParser").Parser,exports.NLMonthNameLittleEndianParser=require("./NL/NLMonthNameLittleEndianParser").Parser,exports.NLMonthNameMiddleEndianParser=require("./NL/NLMonthNameMiddleEndianParser").Parser,exports.NLSlashDateFormatParser=require("./NL/NLSlashDateFormatParser").Parser,exports.NLSlashDateFormatStartWithYearParser=require("./NL/NLSlashDateFormatStartWithYearParser").Parser,exports.NLTimeAgoFormatParser=require("./NL/NLTimeAgoFormatParser").Parser,exports.NLTimeExpressionParser=require("./NL/NLTimeExpressionParser").Parser,exports.NLWeekdayParser=require("./NL/NLWeekdayParser").Parser,exports.NLCasualDateParser=require("./NL/NLCasualDateParser").Parser;
...
var Refiner=require("../refiner").Refiner;exports.Refiner=function(){Refiner.call(this),this.pattern=function(){return/^\s*(tot|\-)\s*$/i},this.refine=function(t,e,n){if(e.length<2)return e;for(var r=[],i=null,s=null,a=1;a<e.length;a++)i=e[a],s=e[a-1],s.end||i.end||!this.isAbleToMerge(t,s,i)||(s=this.mergeResult(t,s,i),i=null,a+=1),r.push(s);return null!=i&&r.push(i),r},this.isAbleToMerge=function(t,e,n){var r=e.index+e.text.length,i=n.index,s=t.substring(r,i);return s.match(this.pattern())},this.mergeResult=function(t,e,n){for(var r in n.start.knownValues)e.start.isCertain(r)||e.start.assign(r,n.start.get(r));for(var r in e.start.knownValues)n.start.isCertain(r)||n.start.assign(r,e.start.get(r));if(e.start.date().getTime()>n.start.date()){var i=n;n=e,e=i}e.end=n.start;for(var s in n.tags)e.tags[s]=!0;var a=Math.min(e.index,n.index),u=Math.max(e.index+e.text.length,n.index+n.text.length);return e.index=a,e.text=t.substring(a,u),e.tags[this.constructor.name]=!0,e}};
...
exports.WEEKDAY_OFFSET={zondag:0,zo:0,zon:0,maandag:1,ma:1,dinsdag:2,di:2,di:2,woensdag:3,woe:3,donderdag:4,"do":4,don:4,vrijdag:5,vrij:5,zaterdag:6,zat:6,za:6},exports.MONTH_OFFSET={januari:1,ja:1,jan:1,"jan.":1,februari:2,feb:2,"feb.":2,maart:3,ma:3,"ma.":3,maa:3,"maa.":3,april:4,apr:4,"apr.":4,mei:5,juni:6,jun:6,"jun.":6,juli:7,jul:7,"jul.":7,augustus:8,aug:8,"aug.":8,september:9,sep:9,"sep.":9,sept:9,"sept.":9,oktober:10,oct:10,"oct.":10,november:11,nov:11,"nov.":11,december:12,dec:12,"dec.":12},exports.NUMBERS={"één":1,een:1,twee:2,drie:3,vier:4,tien:10,twintig:20,vijftien:15,dertig:30,veertig:40,vijftig:50};
},{}]},{},[2])(2)
});
